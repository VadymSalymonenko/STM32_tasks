...
TX_THREAD hello_world_thread;

UCHAR hello_world_thread_stack[1024];
...
{
    tx_thread_create(&hello_world_thread, "Hello world Thread",

                     hello_world_thread_entry, 0,

                     hello_world_thread_stack, sizeof(hello_world_thread_stack),
